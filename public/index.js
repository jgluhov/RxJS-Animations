...
var isArray_1 = __webpack_require__(3);
...
var isPromise_1 = __webpack_require__(14);
var isObject_1 = __webpack_require__(8);
...
var Observable_1 = __webpack_require__(0);
var ScalarObservable_1 = __webpack_require__(18);
...
var from_1 = __webpack_require__(16);
var of_1 = __webpack_require__(21);
var interval_1 = __webpack_require__(42);
var map_1 = __webpack_require__(48);
var tap_1 = __webpack_require__(49);
var concat_1 = __webpack_require__(50);
var mergeMap_1 = __webpack_require__(25);
var takeWhile_1 = __webpack_require__(54);
var animationFrame_1 = __webpack_require__(55);
var distance = function (d) { return function (t) { return t * d; }; };
var msElapsed$ = function (scheduler) {
    if (scheduler === void 0) { scheduler = animationFrame_1.animationFrame; }
    return defer_1.defer(function () {
        var start = scheduler.now(), substractTime = function () { return scheduler.now() - start; };
        return interval_1.interval(0, scheduler)
            .pipe(map_1.map(substractTime));
    });
};
var duration$ = function (ms, scheduler) {
    if (scheduler === void 0) { scheduler = animationFrame_1.animationFrame; }
    return msElapsed$(scheduler)
        .pipe(map_1.map(function (ems) { return ems / ms; }), takeWhile_1.takeWhile(function (t) { return t <= 1; }));
};
...
var moveDown = function (el) { return function (duration$) {
    return duration$
        .pipe(map_1.map(elasticOut), map_1.map(distance(300)), concat_1.concat(of_1.of(300)), tap_1.tap(function (distance) {
        el.style.transform = "translate3d(0, " + distance + "px, 0)";
    }));
}; };
var balls = document.querySelectorAll('.ball');
from_1.from(balls)
    .pipe(mergeMap_1.mergeMap(function (ball, i) {
...
var DeferObservable_1 = __webpack_require__(28);
...
var IntervalObservable_1 = __webpack_require__(43);
...
var concat_1 = __webpack_require__(24);
var concat_2 = __webpack_require__(24);
...
var mergeMap_1 = __webpack_require__(25);
var identity_1 = __webpack_require__(53);
/**
...
var AnimationFrameAction_1 = __webpack_require__(56);
var AnimationFrameScheduler_1 = __webpack_require__(58);
/**
 *
...
var AsyncAction_1 = __webpack_require__(22);
var AnimationFrame_1 = __webpack_require__(57);
/**
 * We need this JSDoc comment for affecting ESDoc.
 * @ignore
 * @extends {Ignored}
